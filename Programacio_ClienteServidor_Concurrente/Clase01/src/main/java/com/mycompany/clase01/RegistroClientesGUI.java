...
public class RegistroClientesGUI extends JFrame implements ActionListener{
    ...
    public RegistroClientesGUI() {
        ...
        lblidPersona.setForeground(Color.BLUE);
        ...
        lblFechaNacimiento.setForeground(Color.BLUE);
        ...
        lblidCliente.setForeground(Color.BLUE);
        ...
        lblLimiteCredito.setForeground(Color.BLUE);
        ...
        String [] columnas = {"ID Persona", "Nombre Completo", "Género", "Fecha Nacimiento",
                             "ID Cliente", "Membresía", "Puntos", "Límite Crédito"};
